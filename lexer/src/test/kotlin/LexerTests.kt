...
//        lexer.setFile(File("C:\\Users\\hilul\\projects\\ingSis\\PrintScript\\lexer\\src\\test\\testfiles\\sample1.txt"))
        lexer.setFile(File("/Users/ezequielrickert/projects/PrintScript/lexer/src/test/testfiles/sample1.txt"))
...
//        lexer.setFile(File("C:\\Users\\hilul\\projects\\ingSis\\PrintScript\\lexer\\src\\test\\testfiles\\sample2.txt"))
        lexer.setFile(File("/Users/ezequielrickert/projects/PrintScript/lexer/src/test/testfiles/sample2.txt"))
        ...
        val typesList: List<TokenType> = listOf(
            ...
            TokenType.ASSIGNATION, TokenType.IDENTIFIER_VAR, TokenType.OPERAND, TokenType.IDENTIFIER_VAR, TokenType.ENDING, TokenType.NATIVE_METHOD, TokenType.STRING_LITERAL, TokenType.OPERAND, TokenType.IDENTIFIER_VAR, TokenType.PARENTHESIS, TokenType.ENDING
        )
...
//        lexer.setFile(File("C:\\Users\\hilul\\projects\\ingSis\\PrintScript\\lexer\\src\\test\\testfiles\\sample3.txt"))
        lexer.setFile(File("/Users/ezequielrickert/projects/PrintScript/lexer/src/test/testfiles/sample3.txt"))
